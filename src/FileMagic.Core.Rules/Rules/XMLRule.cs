...
namespace ldy985.FileMagic.Core.Rules.Rules
{
    public class XMLRule : BaseRule
    {
        ...
        public override ITypeInfo TypeInfo { get; } = new TypeInfo("XML based file", "WSDL");
    ...
    public class XMLBOMRule : BaseRule
    {
        ...
        public override ITypeInfo TypeInfo { get; } = new TypeInfo("XML with BOM based file", "WSDL");
