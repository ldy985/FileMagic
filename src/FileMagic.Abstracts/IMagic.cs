namespace ldy985.FileMagic.Abstracts
{
    ...
    public interface IMagic
    {
        ...
        /// <summary>
        /// The offset shifts the <see cref="Pattern"/> by this amount from the start of the stream. This is used when magic bytes are located beyond the start of the stream.
        /// </summary>
        ulong Offset { get; }
    }
}